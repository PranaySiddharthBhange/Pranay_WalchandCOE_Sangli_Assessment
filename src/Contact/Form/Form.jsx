...
import './Form.css'; // Importing the CSS file for form styling
import emailjs from 'emailjs-com'; // Import EmailJS library for sending emails

const ContactForm = () => {
    // State variables to manage form data, errors, and sending state
            ...
            <div className="form-box">
                <form onSubmit={handleSubmit} className="form">
                    ...
                    <button type="submit" className="button" disabled={isSending}>
                        {isSending ? 'Sending...' : 'Just Send'} <span className="arrow">→</span>
                    </button>
                </form>
            </div>
        </div>
